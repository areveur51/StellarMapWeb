...
- **High Value Account (HVA) Tracking**: Automatic identification and tagging of accounts with >1M XLM balance. Dedicated HVA page displays all high-value accounts with total balance statistics. Efficient boolean-based filtering with is_hva column for scalable queries.
