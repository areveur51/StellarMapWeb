...
- **Advanced Visualization Controls**: User-adjustable sliders for node size (4-15px, default 10px), text size (10-24px, default 18px), vertical spacing (tidy tree only), and min/max child distances (tidy tree only), with all preferences persisting via localStorage and working across both /search and /tree pages.
