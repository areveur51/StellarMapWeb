...
class Command(BaseCommand):
    """
    Scheduled task to collect and store SE directory data (no async needed for single record).
    """
    help = (
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            logger.info(f"{cron_name}: Processed 1 record (SE directory stage currently a no-op)")
