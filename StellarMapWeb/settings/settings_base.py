...
_hva_scan_default = '400' if (LIGHT_MODE or CASSANDRA_READ_ONLY) else '2500'
HVA_CASSANDRA_MAX_SCAN = int(config('HVA_CASSANDRA_MAX_SCAN', default=_hva_scan_default))
_hva_secs_default = '3' if (LIGHT_MODE or CASSANDRA_READ_ONLY) else '6'
HVA_CASSANDRA_MAX_SECONDS = float(
    config('HVA_CASSANDRA_MAX_SECONDS', default=_hva_secs_default)
)
